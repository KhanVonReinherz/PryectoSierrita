...
<head>
  ...
  <title>Reporte de Ventas Esperadas || Chifa Kam Wha</title>
...
<body>
    ...
    try{
    List<String> lista= cat.listarReporte();
   ...
   %>
        ...
        <div class="center">
          ...
          <div class="Indicaciones">
              <ul class="menu">
                  <li>No Se cumplió R.Esperada : Marzo</li>
                  <li>No Se cumplió R.Esperada :Abril</li>
                  <li>No Se cumplió R.Esperada :Mayo</li>
                  <li>No Se cumplió R.Esperada :Junio</li>
                  <li>No Se cumplió R.Esperada Julio</li>
              </ul>
          </div>
           </div>       
</body>
